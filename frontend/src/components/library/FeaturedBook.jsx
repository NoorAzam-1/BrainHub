...
export default function FeaturedBook() {
  return (
    <Link href="/browse" className="group w-full glass-card p-6 rounded-3xl flex flex-col md:flex-row gap-6 items-center cursor-pointer border border-white/60 hover:border-primary/25 transition">
